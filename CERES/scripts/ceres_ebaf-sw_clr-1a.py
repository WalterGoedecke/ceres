...
sw_clr = toa_data.variables['toa_sw_clr_mon'][:, :, :]
...
grid(True)
savefig("../images/CERES_TOF_sw_clr_avg_lats-jan14.png")
show()
...
grid(True)
savefig("../images/CERES_TOF_sw_clr_avg_lats-jul14.png")
show()
...
grid(True)
savefig("../images/CERES_TOF_sw_clr_avg_lats-2014.png")
show()
...
grid(True)
savefig("../images/CERES_TOF_sw_clr_avg_lats-jan_jul_2014.png")
show()
