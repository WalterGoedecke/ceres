# -*- coding: utf-8 -*-
"""
Created on Fri Oct 30 11:16:37 2015
...
toa_data = Dataset('../datasets/CERES_EBAF-TOA_Ed2.8_Subset_201001-201312_solar-sw-lw-net.nc')
...
title('Solar Incoming Short Wave Flux\nJanuary, July, and all Months in 2010-2013', fontsize=18)
grid(True)
savefig("../images/CERES_TOA_solar_incoming_avg_lats-jan_jul_2010-2013.png")
show()
...
xlabel('Latitude (deg)')
ylabel('Radiative flux $(W/m^2)$')
title('Solar Incoming Short Wave Flux\nWinter, Summer, and all Months in 2010-2013', fontsize=18)
grid(True)
savefig("../images/CERES_TOA_solar_incoming_avg_lats-jan-feb-dec_jun-jul-aug_2010-2013.png")
show()
...
grid(True)
savefig("../images/CERES_TOA_outgoing_sw_all_avg_lats-jan_jul_2010-2013.png")
show()
...
title('TOA Solar Short Wave Outgoing Flux, All Sky\n Winter, Summer, and all Months in 2010-2013', fontsize=18)
grid(True)
savefig("../images/CERES_TOA_outgoing_sw_all_avg_lats-jan-feb-dec_jun-jul-aug_2010-2013.png")
show()
#######################
...
grid(True)
savefig("../images/CERES_TOA_absorbed_sw_avg_lats-jan_jul_2010-2013.png")
show()
...
title('CERES TOA Absorbed Short Wave Flux, All Sky\n Winter, Summer, and all Months in 2010-2013', fontsize=18)
grid(True)
savefig("../images/CERES_TOA_absorbed_sw_avg_lats-jan-feb-dec_jun-jul-aug_2010-2013.png")
show()
#######################
...
grid(True)
savefig("../images/CERES_TOA_albedo_avg_lats-jan_jul_2010-2013.png")
show()
...
title('CERES Top of Atmosphere Albedo\n Winter, Summer, and all Months in 2010-2013', fontsize=18)
grid(True)
savefig("../images/CERES_TOA_albedo_avg_lats-jan-feb-dec_jun-jul-aug_2010-2013.png")
show()
...
grid(True)
savefig("../images/CERES_TOA_outgoing_lw_all_avg_lats-jan_jul_2010-2013.png")
show()
...
title('TOA Solar Long Wave Outgoing Flux, All Sky\n Winter, Summer, and all Months in 2010-2013', fontsize=18)
grid(True)
savefig("../images/CERES_TOA_outgoing_lw_all_avg_lats-jan-feb-dec_jun-jul-aug_2010-2013.png")
show()
...
grid(True)
savefig("../images/CERES_TOA_incoming_net_all_avg_lats-jan_jul_2010-2013.png")
show()
...
title('TOA Solar Net Incoming Short & Long Wave Flux, All Sky\n Winter, Summer, and all Months in 2010-2013', fontsize=18)
grid(True)
savefig("../images/CERES_TOA_incoming_net_all_avg_lats-jan-feb-dec_jun-jul-aug_2010-2013.png")
show()
#######################
