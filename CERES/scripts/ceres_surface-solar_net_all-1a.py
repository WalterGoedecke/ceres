...
grid(True)
savefig("../images/CERES_sfc_solar_net_all_avg_lats-jan14.png")
show()
...
grid(True)
savefig("../images/CERES_sfc_solar_net_all_avg_lats-jul14.png")
show()
...
grid(True)
savefig("../images/CERES_sfc_solar_net_all_avg_lats-2014.png")
show()
...
xlabel('Latitude (deg)')
ylabel('Radiative flux $(W/m^2)$')
title('Surface Solar Net Flux for January, July, and all Months in 2014\n All Sky', fontsize=16)
grid(True)
savefig("../images/CERES_sfc_solar_net_all_avg_lats-jan_jul_2014.png")
show()
