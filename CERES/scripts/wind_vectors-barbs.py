# -*- coding: utf-8 -*-
"""
Created on Fri Oct  9 13:40:53 2015
...
# set plot title
ax.set_title('Sea Level Pressure and Wind Vectors '+str(date))
plt.show()

# Save figure. 
fig1.savefig("images/wind_vectors-barbs_proj-ortho.png")
#fig1.savefig("wind_vectors-barbs_proj-ortho.png")
