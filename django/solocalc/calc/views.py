...
from calc.models import Calculation #, CalculationAdmin
from django.core.context_processors import csrf
from django.core.exceptions import *

from solocalc.settings import STATIC_URL, MEDIA_URL
...
def calcform(request):
    ...
    if last_calc:
        ...
        return render_to_response("calc/pages/calcform.html", add_csrf(request, pf=pf, address_slug=address_slug, 
        ...
        return render_to_response("calc/pages/calcform.html", add_csrf(request, pf=pf 
                                                         ))
