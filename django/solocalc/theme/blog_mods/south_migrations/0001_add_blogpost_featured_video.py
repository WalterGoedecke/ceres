...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_blogpost', u'featured_video',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BlogPost.featured_video'
        db.delete_column(u'blog_blogpost', u'featured_video')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'comments': ('mezzanine.generic.fields.CommentsField', [], {'object_id_field': "u'object_pk'", 'to': u"orm['generic.ThreadedComment']", u'frozen_by_south': 'True'}),
            ...
            u'featured_video': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
