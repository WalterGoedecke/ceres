...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.header_image'
        db.add_column(u'theme_homepage', 'header_image',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.header_image'
        db.delete_column(u'theme_homepage', 'header_image')
