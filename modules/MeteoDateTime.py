...
# test classes
class TestDateTimeendar(unittest.TestCase):
...
class TestBuiltInDateTimeendar(unittest.TestCase):

    def setUp(self):
        self.year = datetime.date.today().year
        self.calendar = calendar.DateTimeendar()

    def testYearDatesDateTimeendar(self):
        yearDateTimeendar = self.calendar.yeardatescalendar(self.year)
...
if __name__ == "__main__":
    suiteDateTimeendar \
        = unittest.TestLoader().loadTestsFromTestCase(TestDateTimeendar)
    suiteBuiltInDateTimeendar \
        = unittest.TestLoader().loadTestsFromTestCase(TestBuiltInDateTimeendar)
    tests = unittest.TestSuite([suiteDateTimeendar, suiteBuiltInDateTimeendar])
